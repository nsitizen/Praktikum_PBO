...
public class Staff
{
    ...
    public Staff()
    {
        ...
        staffList[6] = new Commission("Budi", "Jl. Java 10", "555-1111", 
                "111-22-333", 6.25, 0.20); // Gaji $6.25/jam, komisi 20%
        staffList[7] = new Commission("Siti", "Jl. Koding 20", "555-2222", 
                "444-55-666", 9.75, 0.15); // Gaji $9.75/jam, komisi 15%
